        ...
        <div class="flex flex-col space-y-2 p-4">
          ...
          <div class="w-full sm:w-2/3">
            <Multiselect 
              ...
              :options="routes.includes(form.route_or_url) ? routes : [form.route_or_url, ...routes]"
              :clearOnSearch="false"
              :clearOnSelect="false"
              :searchable="true"
              :createTag="true"
...
<script>
  ...
  export default defineComponent({
    ...
    methods: {
      submit() {
        return this.form.patch(route('superuser.menu.update', this.menu.id), {
    ...
    mounted() {
      ...
      this.form.route_or_url = this.menu.route_or_url
      this.form.routes = this.menu.routes
      this.form.permissions = this.menu.permissions.map(permission => permission.id)
    },
  })
</script>
